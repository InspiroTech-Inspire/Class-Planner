...
A simple, no-login weekly coursework tracker. Add a class, add weeks (WK 1, WK 2, …), and log Assignments or Discussion posts. Discussion posts automatically get a Discussion Post row plus Reply 1 and Reply 2 rows. Every row has its own due date, a status dropdown (Not started / Started / Submitted / Completed), and a stamp checkbox to mark it done at a glance.
